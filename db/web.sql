...
('충만치킨', '간장티꾸닭', 22000, 'chung2.jpg'),
('충만치킨', '매콤마늘 양념치킨', 20000, 'chung4.jpg'),
('충만치킨', '베이컨스피니치', 23000, 'chung6.jpg'),
('충만치킨', '스노우 어니언', 21000, 'chung3.jpg'),
('충만치킨', '충만 후라이드', 19000, 'chung1.jpg'),
('충만치킨', '치즈몬스터치킨', 22000, 'chung5.jpg'),
...
('충만치킨', '042-274-7799', '17:00 ~ 25:00', '대전 대덕구 한남로12번길 19-5', 'chung.jpg'),
